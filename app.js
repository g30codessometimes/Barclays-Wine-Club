...
async function loadPortfolio() {
  try {
    const response = await fetch(CONFIG.PORTFOLIO_URL, {cache: "no-store"});
    ...
    $("errorMessage").textContent =
      "The portfolio could not be loaded. Please check that the Vibrant price list is online and try again.";
  }
}
